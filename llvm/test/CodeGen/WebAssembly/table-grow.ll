...
declare i32 @llvm.wasm.table.grow.wasmref.twasm.externreft(ptr addrspace(1), %externref, i32) nounwind readonly
declare %externref @llvm.wasm.ref.null.extern.twasm.externreft() nounwind readonly
...
; CHECK-NEXT:  end_function
  ...
  %newsz = call i32 @llvm.wasm.table.grow.wasmref.twasm.externreft(ptr addrspace(1) @externref_table, %externref %null, i32 %sz)
  ret i32 %newsz
}
