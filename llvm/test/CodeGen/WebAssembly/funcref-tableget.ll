...
declare %funcref @llvm.wasm.table.get.wasmref.twasm.funcreft(ptr addrspace(1), i32) nounwind
...
; CHECK-NEXT: end_function
  %ref = call %funcref @llvm.wasm.table.get.wasmref.twasm.funcreft(ptr addrspace(1) @funcref_table, i32 %i)
  ret %funcref %ref
}
...
; CHECK-NEXT:  table.get      funcref_table
; CHECK-NEXT:  end_function
  %ref = call %funcref @llvm.wasm.table.get.wasmref.twasm.funcreft(ptr addrspace(1) @funcref_table, i32 0)
  ret %funcref %ref
}
...
; CHECK-NEXT:  end_function
  %off = add nsw i32 %i, 2
  %ref = call %funcref @llvm.wasm.table.get.wasmref.twasm.funcreft(ptr addrspace(1) @funcref_table, i32 %off)
  ret %funcref %ref
}
