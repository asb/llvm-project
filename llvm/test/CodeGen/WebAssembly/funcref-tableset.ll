...
declare void @llvm.wasm.table.set.wasmref.twasm.funcreft(ptr addrspace(1), i32, %funcref) nounwind
...
;; this generates a table.set of @funcref_table
  call void @llvm.wasm.table.set.wasmref.twasm.funcreft(ptr addrspace(1) @funcref_table, i32 %i, %funcref %g)
  ret void
}
...
; CHECK-NEXT:  table.set      funcref_table
; CHECK-NEXT:  end_function
  call void @llvm.wasm.table.set.wasmref.twasm.funcreft(ptr addrspace(1) @funcref_table, i32 0, %funcref %g)
  ret void
}
...
; CHECK-NEXT:  end_function
  %off = add nsw i32 %i, 2
  call void @llvm.wasm.table.set.wasmref.twasm.funcreft(ptr addrspace(1) @funcref_table, i32 %off, %funcref %g)
  ret void
}
